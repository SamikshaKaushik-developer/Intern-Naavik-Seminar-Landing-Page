...
document.querySelector('#registration form').addEventListener('submit', function(e) {
    ...
    const params = new URLSearchParams({
        'usp': 'pp_url',
        'entry.190724952': fullName,
        'entry.786790121': schoolName,
        'entry.1748774961': city,
        'entry.1381997137': contactNumber,
        'entry.1853064802': emailAddress,
        'entry.1123236580': selectEvent
    });
...
// Check for and apply saved theme on load
